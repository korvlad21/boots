                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        @guest
                            <li class="nav-item active">
                                <a class="nav-link text-white" href="/">О нашем магазине<span class="sr-only">(current)</span></a>
                            </li>


                        @else
                            <li class="nav-item active">
                                <a class="nav-link text-white" href="{{ route('product.index')}}">Каталог товаров<span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item active">
                                <a class="nav-link text-white" href="{{ route('order.index')}}">Мои заказы<span class="sr-only">(current)</span></a>
                            </li>
