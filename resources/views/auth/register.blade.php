                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="otchestvo" type="text" class="form-control @error('otchestvo') is-invalid @enderror" name="otchestvo" value="{{ old('otchestvo') }}"  autocomplete="otchestvo" autofocus>
